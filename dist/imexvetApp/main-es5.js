...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_public_public_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var _components_admin_pedidos_admin_pedidos_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/admin-pedidos/admin-pedidos.component */
    ...
    var _components_admin_productos_admin_productos_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/admin-productos/admin-productos.component */
    "./src/app/components/admin-productos/admin-productos.component.ts");
    /* harmony import */


    var _components_crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/crear-producto/crear-producto.component */
    "./src/app/components/crear-producto/crear-producto.component.ts");
    /* harmony import */


    var _components_nosotros_nosotros_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/nosotros/nosotros.component */
    "./src/app/components/nosotros/nosotros.component.ts");
    /* harmony import */


    var _components_contacto_contacto_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/contacto/contacto.component */
    "./src/app/components/contacto/contacto.component.ts");
    /* harmony import */


    var _components_puntos_venta_puntos_venta_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/puntos-venta/puntos-venta.component */
    "./src/app/components/puntos-venta/puntos-venta.component.ts");
    /* harmony import */


    var _components_productos_perros_productos_perros_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/productos-perros/productos-perros.component */
    "./src/app/components/productos-perros/productos-perros.component.ts");
    /* harmony import */


    var _components_productos_gatos_productos_gatos_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/productos-gatos/productos-gatos.component */
    "./src/app/components/productos-gatos/productos-gatos.component.ts");
    /* harmony import */


    var _components_catalogo_catalogo_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/catalogo/catalogo.component */
    "./src/app/components/catalogo/catalogo.component.ts");

    var routes = [{
      path: '',
      component: _components_public_public_component__WEBPACK_IMPORTED_MODULE_2__["PublicComponent"],
      children: [{
        path: '',
        component: _components_inicio_inicio_component__WEBPACK_IMPORTED_MODULE_3__["InicioComponent"]
      }, {
        path: 'productos/perros',
        component: _components_productos_perros_productos_perros_component__WEBPACK_IMPORTED_MODULE_11__["ProductosPerrosComponent"]
      }, {
        path: 'productos/gatos',
        component: _components_productos_gatos_productos_gatos_component__WEBPACK_IMPORTED_MODULE_12__["ProductosGatosComponent"]
      }, {
        path: 'puntosVenta',
        component: _components_puntos_venta_puntos_venta_component__WEBPACK_IMPORTED_MODULE_10__["PuntosVentaComponent"]
      }, {
        path: 'nosotros',
        component: _components_nosotros_nosotros_component__WEBPACK_IMPORTED_MODULE_8__["NosotrosComponent"]
      }, {
        path: 'contacto',
        component: _components_contacto_contacto_component__WEBPACK_IMPORTED_MODULE_9__["ContactoComponent"]
      }, {
        path: 'catalogo',
        component: _components_catalogo_catalogo_component__WEBPACK_IMPORTED_MODULE_13__["CatalogoComponent"]
      }]
    }, {
      path: 'admin',
      ...
      children: [{
        path: 'pedidos',
        component: _components_admin_pedidos_admin_pedidos_component__WEBPACK_IMPORTED_MODULE_4__["AdminPedidosComponent"]
      }, {
        path: 'productos',
        component: _components_admin_productos_admin_productos_component__WEBPACK_IMPORTED_MODULE_6__["AdminProductosComponent"]
      }, {
        path: 'crearProducto',
        component: _components_crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_7__["CrearProductoComponent"]
      }]
    }, {
      path: '**',
      pathMatch: 'full',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    /*! ./app.component */
    "./src/app/app.component.ts");
    /* harmony import */


    var _components_header_header_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
    /*! ./components/header/header.component */
    "./src/app/components/header/header.component.ts");
    /* harmony import */


    var _components_footer_footer_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    /*! ./components/footer/footer.component */
    "./src/app/components/footer/footer.component.ts");
    /* harmony import */


    var _components_inicio_inicio_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
    /*! ./components/inicio/inicio.component */
    "./src/app/components/inicio/inicio.component.ts");
    /* harmony import */


    var _components_public_public_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    /*! ./components/public/public.component */
    "./src/app/components/public/public.component.ts");
    /* harmony import */


    var _components_card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
    /*! ./components/card-producto/card-producto.component */
    "./src/app/components/card-producto/card-producto.component.ts");
    /* harmony import */


    var _components_menu_mobile_menu_mobile_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(
    /*! ./components/menu-mobile/menu-mobile.component */
    "./src/app/components/menu-mobile/menu-mobile.component.ts");
    /* harmony import */


    var _components_crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
    /*! ./components/crear-producto/crear-producto.component */
    "./src/app/components/crear-producto/crear-producto.component.ts");
    /* harmony import */


    var _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(
    /*! ./components/admin/admin.component */
    "./src/app/components/admin/admin.component.ts");
    /* harmony import */


    var _components_admin_productos_admin_productos_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(
    /*! ./components/admin-productos/admin-productos.component */
    "./src/app/components/admin-productos/admin-productos.component.ts");
    /* harmony import */


    var _components_admin_pedidos_admin_pedidos_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(
    /*! ./components/admin-pedidos/admin-pedidos.component */
    "./src/app/components/admin-pedidos/admin-pedidos.component.ts");
    /* harmony import */


    var _components_producto_detalle_admin_producto_detalle_admin_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(
    /*! ./components/producto-detalle-admin/producto-detalle-admin.component */
    "./src/app/components/producto-detalle-admin/producto-detalle-admin.component.ts");
    /* harmony import */


    var _components_eliminar_producto_eliminar_producto_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(
    /*! ./components/eliminar-producto/eliminar-producto.component */
    "./src/app/components/eliminar-producto/eliminar-producto.component.ts");
    /* harmony import */


    var _components_editar_producto_editar_producto_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(
    /*! ./components/editar-producto/editar-producto.component */
    "./src/app/components/editar-producto/editar-producto.component.ts");
    /* harmony import */


    var _components_admin_marcas_admin_marcas_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(
    /*! ./components/admin-marcas/admin-marcas.component */
    "./src/app/components/admin-marcas/admin-marcas.component.ts");
    /* harmony import */


    var _components_nosotros_nosotros_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(
    /*! ./components/nosotros/nosotros.component */
    "./src/app/components/nosotros/nosotros.component.ts");
    /* harmony import */


    var _components_contacto_contacto_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(
    /*! ./components/contacto/contacto.component */
    "./src/app/components/contacto/contacto.component.ts");
    /* harmony import */


    var _components_puntos_venta_puntos_venta_component__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(
    /*! ./components/puntos-venta/puntos-venta.component */
    "./src/app/components/puntos-venta/puntos-venta.component.ts");
    /* harmony import */


    var _components_productos_perros_productos_perros_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(
    /*! ./components/productos-perros/productos-perros.component */
    "./src/app/components/productos-perros/productos-perros.component.ts");
    /* harmony import */


    var _components_productos_gatos_productos_gatos_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(
    /*! ./components/productos-gatos/productos-gatos.component */
    "./src/app/components/productos-gatos/productos-gatos.component.ts");
    /* harmony import */


    var _components_catalogo_catalogo_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(
    /*! ./components/catalogo/catalogo.component */
    "./src/app/components/catalogo/catalogo.component.ts"); // Angularfire2
    // Angular Material
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_40__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebase), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestoreModule"], _angular_fire_storage__WEBPACK_IMPORTED_MODULE_7__["AngularFireStorageModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_18__["MatDialogModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_20__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_23__["MatInputModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_29__["MatSelectModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_14__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_32__["MatSliderModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_33__["MatSnackBarModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_36__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_26__["MatPaginatorModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_34__["MatSortModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_31__["MatSlideToggleModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_22__["MatIconModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_21__["MatGridListModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_10__["MatAutocompleteModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_13__["MatCardModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_37__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_38__["MatToolbarModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_28__["MatRadioModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_17__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_15__["MatChipsModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_30__["MatSidenavModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_24__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_25__["MatMenuModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_35__["MatStepperModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_19__["MatExpansionModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_39__["MatTooltipModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_11__["MatBadgeModule"], ngx_material_file_input__WEBPACK_IMPORTED_MODULE_8__["MaterialFileInputModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_41__["AppComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_42__["HeaderComponent"], _components_footer_footer_component__WEBPACK_IMPORTED_MODULE_43__["FooterComponent"], _components_inicio_inicio_component__WEBPACK_IMPORTED_MODULE_44__["InicioComponent"], _components_public_public_component__WEBPACK_IMPORTED_MODULE_45__["PublicComponent"], _components_card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_46__["CardProductoComponent"], _components_menu_mobile_menu_mobile_component__WEBPACK_IMPORTED_MODULE_47__["MenuMobileComponent"], _components_crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_48__["CrearProductoComponent"], _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_49__["AdminComponent"], _components_admin_productos_admin_productos_component__WEBPACK_IMPORTED_MODULE_50__["AdminProductosComponent"], _components_admin_pedidos_admin_pedidos_component__WEBPACK_IMPORTED_MODULE_51__["AdminPedidosComponent"], _components_producto_detalle_admin_producto_detalle_admin_component__WEBPACK_IMPORTED_MODULE_52__["ProductoDetalleAdminComponent"], _components_eliminar_producto_eliminar_producto_component__WEBPACK_IMPORTED_MODULE_53__["EliminarProductoComponent"], _components_editar_producto_editar_producto_component__WEBPACK_IMPORTED_MODULE_54__["EditarProductoComponent"], _components_admin_marcas_admin_marcas_component__WEBPACK_IMPORTED_MODULE_55__["AdminMarcasComponent"], _components_nosotros_nosotros_component__WEBPACK_IMPORTED_MODULE_56__["NosotrosComponent"], _components_contacto_contacto_component__WEBPACK_IMPORTED_MODULE_57__["ContactoComponent"], _components_puntos_venta_puntos_venta_component__WEBPACK_IMPORTED_MODULE_58__["PuntosVentaComponent"], _components_productos_perros_productos_perros_component__WEBPACK_IMPORTED_MODULE_59__["ProductosPerrosComponent"], _components_productos_gatos_productos_gatos_component__WEBPACK_IMPORTED_MODULE_60__["ProductosGatosComponent"], _components_catalogo_catalogo_component__WEBPACK_IMPORTED_MODULE_61__["CatalogoComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_40__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestoreModule"], _angular_fire_storage__WEBPACK_IMPORTED_MODULE_7__["AngularFireStorageModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_18__["MatDialogModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_20__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_23__["MatInputModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_29__["MatSelectModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_14__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_32__["MatSliderModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_33__["MatSnackBarModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_36__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_26__["MatPaginatorModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_34__["MatSortModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_31__["MatSlideToggleModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_22__["MatIconModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_21__["MatGridListModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_10__["MatAutocompleteModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_13__["MatCardModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_37__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_38__["MatToolbarModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_28__["MatRadioModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_17__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_15__["MatChipsModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_30__["MatSidenavModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_24__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_25__["MatMenuModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_35__["MatStepperModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_19__["MatExpansionModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_39__["MatTooltipModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_11__["MatBadgeModule"], ngx_material_file_input__WEBPACK_IMPORTED_MODULE_8__["MaterialFileInputModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppClassesProductoTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsAdminMarcasAdminMarcasComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdminMarcasComponent", function () {
      return AdminMarcasComponent;
    });
    /* harmony import */
    ...
    var AdminMarcasComponent = /*#__PURE__*/function () {
      function AdminMarcasComponent() {
        _classCallCheck(this, AdminMarcasComponent);
      }

      _createClass(AdminMarcasComponent, [{
        key: "ngOnInit",
    ...
    AdminMarcasComponent.ɵfac = function AdminMarcasComponent_Factory(t) {
      return new (t || AdminMarcasComponent)();
    };

    AdminMarcasComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AdminMarcasComponent,
      selectors: [["app-admin-marcas"]],
      decls: 2,
      vars: 0,
      template: function AdminMarcasComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminMarcasComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsAdminPedidosAdminPedidosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdminPedidosComponent", function () {
    ...
    var AdminPedidosComponent = /*#__PURE__*/function () {
      function AdminPedidosComponent() {
        _classCallCheck(this, AdminPedidosComponent);
      }

      _createClass(AdminPedidosComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    AdminPedidosComponent.ɵfac = function AdminPedidosComponent_Factory(t) {
      return new (t || AdminPedidosComponent)();
    };

    AdminPedidosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AdminPedidosComponent,
      selectors: [["app-admin-pedidos"]],
      decls: 2,
      vars: 0,
      template: function AdminPedidosComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminPedidosComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsAdminProductosAdminProductosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _producto_detalle_admin_producto_detalle_admin_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../producto-detalle-admin/producto-detalle-admin.component */
    "./src/app/components/producto-detalle-admin/producto-detalle-admin.component.ts");
    /* harmony import */


    var _eliminar_producto_eliminar_producto_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../eliminar-producto/eliminar-producto.component */
    "./src/app/components/eliminar-producto/eliminar-producto.component.ts");
    /* harmony import */


    var _editar_producto_editar_producto_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../editar-producto/editar-producto.component */
    "./src/app/components/editar-producto/editar-producto.component.ts");
    /* harmony import */


    var _crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../crear-producto/crear-producto.component */
    "./src/app/components/crear-producto/crear-producto.component.ts");
    /* harmony import */


    var _services_firebase_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    function AdminProductosComponent_th_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "C\xF3digo");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function AdminProductosComponent_td_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AdminProductosComponent_th_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Fecha creaci\xF3n");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function AdminProductosComponent_td_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Ubicaci\xF3n");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function AdminProductosComponent_td_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_28_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_31_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_33_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_34_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 26);
    ...
    function AdminProductosComponent_th_36_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_37_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AdminProductosComponent_td_37_Template_mat_slide_toggle_ngModelChange_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r39);

          var producto_r36 = ctx.$implicit;

          var ctx_r38 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r38.actualizarPublicado(producto_r36.id, producto_r36, $event);
        });
    ...
    function AdminProductosComponent_th_39_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 25);
    ...
    function AdminProductosComponent_td_40_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AdminProductosComponent_td_40_Template_mat_checkbox_ngModelChange_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r43);

          var producto_r40 = ctx.$implicit;

          var ctx_r42 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r42.actualizarDestacado(producto_r40.id, producto_r40, $event);
        });
    ...
    function AdminProductosComponent_th_42_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AdminProductosComponent_td_43_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminProductosComponent_td_43_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r46);

          var producto_r44 = ctx.$implicit;

          var ctx_r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r45.openModalDetalle(producto_r44);
        });
    ...
    function AdminProductosComponent_th_45_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 32);
    ...
    function AdminProductosComponent_td_46_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminProductosComponent_td_46_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r49);

          var producto_r47 = ctx.$implicit;

          var ctx_r48 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r48.openModalEdit(producto_r47);
        });
    ...
    function AdminProductosComponent_th_48_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 32);
    ...
    function AdminProductosComponent_td_49_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminProductosComponent_td_49_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r52);

          var producto_r50 = ctx.$implicit;

          var ctx_r51 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r51.openModalDelete(producto_r50);
        });
    ...
    function AdminProductosComponent_tr_50_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 35);
      }
    }

    function AdminProductosComponent_tr_51_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AdminProductosComponent = /*#__PURE__*/function () {
      function AdminProductosComponent(fs, dialog) {
      ...
      _createClass(AdminProductosComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.fs.getAllProducts().subscribe(function (data) {
            _this.productsData.data = data;
            _this.loading = false;
        ...
        key: "openModalCrear",
        value: function openModalCrear() {
          var dialogRef = this.dialog.open(_crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_7__["CrearProductoComponent"], {
        ...
        key: "eliminarAviso",
        value: function eliminarAviso(idProduct) {
          this.fs.deleteProduct(idProduct);
        }
      }, {
        key: "openModalDetalle",
        value: function openModalDetalle(producto) {
          var dialogRef = this.dialog.open(_producto_detalle_admin_producto_detalle_admin_component__WEBPACK_IMPORTED_MODULE_4__["ProductoDetalleAdminComponent"], {
            panelClass: 'modalFullScreen',
            data: producto
          });
          dialogRef.afterClosed().subscribe();
        ...
        key: "openModalDelete",
        value: function openModalDelete(producto) {
          var dialogRef = this.dialog.open(_eliminar_producto_eliminar_producto_component__WEBPACK_IMPORTED_MODULE_5__["EliminarProductoComponent"], {
            data: producto
          });
          dialogRef.afterClosed().subscribe();
        }
        ...
        key: "openModalEdit",
        value: function openModalEdit(producto) {
          var dialogRef = this.dialog.open(_editar_producto_editar_producto_component__WEBPACK_IMPORTED_MODULE_6__["EditarProductoComponent"], {
            panelClass: 'modalFullScreen',
            data: producto
          });
          dialogRef.afterClosed().subscribe();
        ...
        value: function ngAfterViewInit() {
          this.productsData.paginator = this.paginator; // this.avisosData.sort = this.sort;
        }
      }, {
        key: "actualizarPublicado",
        value: function actualizarPublicado(key, obj, e) {
          this.fs.updateAprobado(key, e);
        }
      }, {
        key: "actualizarDestacado",
        value: function actualizarDestacado(key, obj, e) {
          this.fs.updateDestacado(key, e);
        }
      }, {
        key: "trackByPublicado",
        value: function trackByPublicado(item) {
    ...
    AdminProductosComponent.ɵfac = function AdminProductosComponent_Factory(t) {
      return new (t || AdminProductosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_8__["FirebaseService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialog"]));
    };

    AdminProductosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AdminProductosComponent,
      selectors: [["app-admin-productos"]],
      viewQuery: function AdminProductosComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function AdminProductosComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminProductosComponent_Template_button_click_5_listener() {
            return ctx.openModalCrear();
          });
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_15__["DatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_15__["SlicePipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminProductosComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _services_firebase_service__WEBPACK_IMPORTED_MODULE_8__["FirebaseService"]
        }, {
  ...
  /***/
  function srcAppComponentsCardProductoCardProductoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CardProductoComponent", function () {
    ...
    function CardProductoComponent_div_13_div_4_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var presentacion_r2 = ctx.$implicit;
    ...
    function CardProductoComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CardProductoComponent = /*#__PURE__*/function () {
      function CardProductoComponent() {
        _classCallCheck(this, CardProductoComponent);
      }

      _createClass(CardProductoComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    CardProductoComponent.ɵfac = function CardProductoComponent_Factory(t) {
      return new (t || CardProductoComponent)();
    };

    CardProductoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CardProductoComponent,
      selectors: [["app-card-producto"]],
      inputs: {
        producto: "producto"
      },
      decls: 17,
      vars: 5,
      consts: [[1, "boxProduct", "h-100", "position-relative"], [1, "d-flex", "flex-column", "h-100"], ["width", "100%", 1, "image", 3, "src"], [1, "p-3", "d-flex", "align-items-start", "flex-column"], [1, "d-flex", "justify-content-between", "align-items-center", "w-100", "mb-2", 2, "font-size", "0.7rem"], [1, "rounded", "p-1", "bg-secondary", "text-white"], [1, "text-right"], [1, "titulo", "mb-2"], ["class", "", 4, "ngIf"], [1, "w-100", "mt-auto", "px-3", "pb-3"], ["href", "https://imexvetperu.riqra.com/", "target", "_blank", 1, "btn", "btn-outline-secondary", "btn-block", "stretched-link"], [1, ""], [1, "small", "text-muted", "mb-1"], [1, "d-flex"], ["class", "rounded-sm border px-2 py-1 mr-2 small", 4, "ngFor", "ngForOf"], [1, "rounded-sm", "border", "px-2", "py-1", "mr-2", "small"]],
      template: function CardProductoComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, "Compra aqu\xED");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CardProductoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsCatalogoCatalogoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    CatalogoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 0,
      consts: [[1, "col-md-10", "mx-auto", "py-4", "py-md-6", "text-center"], ["href", "https://firebasestorage.googleapis.com/v0/b/imexvetperu-36f06.appspot.com/o/catalogo-imexvet-2020.pdf?alt=media&token=1981c055-3526-4c89-b5cc-433a89999d83", "target", "blank", 1, "btn", "btn-primary", "btn-lg"]],
      template: function CatalogoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, " Ver Cat\xE1logo ");
    ...
    ContactoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ContactoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Si t\xFA est\xE1s bien,");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "p", 4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "ellos est\xE1n bien.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Cont\xE1ctanos al:");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Horario de atenci\xF3n de Pedidos");
  ...
  /***/
  function srcAppComponentsCrearProductoCrearProductoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function CrearProductoComponent_mat_checkbox_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_mat_option_15_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var categoria_r13 = ctx.$implicit;
    ...
    function CrearProductoComponent_mat_option_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 28);
    ...
    function CrearProductoComponent_button_32_Template(rf, ctx) {
      if (rf & 1) {
        var _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 29);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CrearProductoComponent_button_32_Template_button_click_0_listener($event) {
    ...
    function CrearProductoComponent_mat_icon_33_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_mat_error_34_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_mat_radio_button_38_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_div_39_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_div_40_div_1_mat_option_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 28);
    ...
    function CrearProductoComponent_div_40_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Presentaci\xF3n");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CrearProductoComponent_div_40_div_1_Template_button_click_17_listener() {
          ...
          return ctx_r23.eliminarPresentacion(i_r20);
        });
    ...
    function CrearProductoComponent_div_40_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CrearProductoComponent_div_40_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26);

          var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r25.agregarPresentacion();
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Agregar presentaci\xF3n");
    ...
    function CrearProductoComponent_mat_icon_43_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CrearProductoComponent_mat_spinner_44_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CrearProductoComponent = /*#__PURE__*/function () {
      function CrearProductoComponent(fs, ds, fb, router, dialogRef, afs, storage) {
      ...
      _createClass(CrearProductoComponent, [{
        ...
        value: function ngOnInit() {
          this.formProduct = this.fb.group({
            ...
            precio: [''],
            presentaciones: this.fb.array([this.fb.group({
              presentacion: [''],
              medida: [''],
              precio: ['']
            })])
        ...
        value: function crearProducto() {
          ...
          this.fs.addProduct(this.formProduct.value).then(function () {
        ...
        key: "uploadFileAndCrearProducto",
        value: function uploadFileAndCrearProducto() {
          var _this3 = this;

          var myTest = this.afs.collection('productos').ref.doc();
          console.log(myTest.id);
          var file = this.selectedFile; // const filePath = `imagesProducts/${myTest.id}/name1`;

          var filePath = "imagesProducts/".concat(myTest.id, "/").concat(this.nameItem);
          ...
          task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
            fileRef.getDownloadURL().toPromise().then(function (url) {
              ...
              myTest.set({
                familia: _this3.formProduct.value.familia,
                categoria: _this3.formProduct.value.categoria,
                marca: _this3.formProduct.value.marca,
                nombre: _this3.formProduct.value.nombre,
                image: _this3.downloadURL,
                imageName: _this3.nameItem,
                publicado: _this3.formProduct.value.publicado,
                destacado: _this3.formProduct.value.destacado,
                fechaCreacion: _this3.formProduct.value.fechaCreacion,
                tipo: _this3.formProduct.value.tipo,
                precio: _this3.formProduct.value.precio,
                presentaciones: _this3.formProduct.value.presentaciones
              });
        ...
        key: "agregarPresentacion",
        value: function agregarPresentacion() {
        ...
        key: "eliminarPresentacion",
        value: function eliminarPresentacion(index) {
          // tslint:disable-next-line:no-string-literal
          // (this.formProduct.controls['presentaciones']as FormArray).removeAt(index);
          var control = this.formProduct.controls.presentaciones;
        ...
        key: "errorImagen",
        value: function errorImagen() {
          return this.formProduct.controls.image.hasError('required') ? 'La imagen es necesaria' : this.formProduct.controls.image.hasError('maxContentSize') ? 'El peso de la imagen no debe exceder a 1 MB' : '';
        }
      }]);
    ...
    CrearProductoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CrearProductoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CrearProductoComponent_Template_button_click_4_listener() {
            return ctx.cancelar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function CrearProductoComponent_Template_form_submit_7_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Categor\xEDa");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CrearProductoComponent_Template_ngx_mat_file_input_change_30_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](36, "Peso m\xE1ximo de la imagen: 1 MB.");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.formProduct.value.tipo === "Presentaci\xF3n \xFAnica");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.formProduct.value.tipo === "Presentaci\xF3n m\xFAltiple");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CrearProductoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsEditarProductoEditarProductoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_firebase_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var _classes_producto__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../classes/producto */
    "./src/app/classes/producto.ts");
    /* harmony import */
    ...
    function EditarProductoComponent_mat_checkbox_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_mat_option_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_mat_option_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 30);
    ...
    function EditarProductoComponent_button_35_Template(rf, ctx) {
      if (rf & 1) {
        var _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 31);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditarProductoComponent_button_35_Template_button_click_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);
    ...
    function EditarProductoComponent_mat_icon_36_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_mat_error_37_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function EditarProductoComponent_mat_radio_button_41_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_div_42_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_div_43_div_1_mat_option_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 30);
    ...
    function EditarProductoComponent_div_43_div_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditarProductoComponent_div_43_div_1_Template_button_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);
    ...
    function EditarProductoComponent_div_43_Template(rf, ctx) {
      if (rf & 1) {
        var _r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditarProductoComponent_div_43_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26);
    ...
    function EditarProductoComponent_mat_icon_46_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditarProductoComponent_mat_spinner_47_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EditarProductoComponent = /*#__PURE__*/function () {
      function EditarProductoComponent(dialogRef, data, snackBar, fb, fs, ds, afs, storage) {
        ...
        this.maxSize = 1048576; // const selectedImage = this.storage.ref(`imagesProducts/${this.data.id}/${this.data.imageName}`)

        var selectedImage = this.storage.ref('imagesProducts/7CDiCRsE5Kc2CS1QGFpm/Pronature_03AdultoCordero.jpg');
      ...
      _createClass(EditarProductoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.data.presentaciones.forEach(function (x) {
            _this5.formProduct.controls['presentaciones'].push(_this5.fb.group(x));
          });
          this.animales = this.fs.getAnimales();
          this.categorias = this.fs.getCategorias();
          this.marcas = this.fs.getMarcas();
          this.tipos = this.ds.tipos;
          this.medidas = this.ds.medidas; // console.log(this.data);
        ...
        key: "editarAviso",
        value: function editarAviso() {
          var _this6 = this;

          this.fs.updateProduct(this.data.id, this.formProduct.value).then(function () {
            _this6.dialogRef.close();

            _this6.snackBar.open('Producto actualizado', 'CERRAR', {
              duration: 3000
            });
          });
        }
        ...
        value: function uploadFileAndCrearProducto() {
          ...
          task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
            fileRef.getDownloadURL().toPromise().then(function (url) {
              ...
              myTest.update({
                familia: _this7.formProduct.value.familia,
                categoria: _this7.formProduct.value.categoria,
                marca: _this7.formProduct.value.marca,
                nombre: _this7.formProduct.value.nombre,
                image: _this7.downloadURL,
                publicado: _this7.formProduct.value.publicado,
                fechaCreacion: _this7.formProduct.value.fechaCreacion,
                tipo: _this7.formProduct.value.tipo,
                precio: _this7.formProduct.value.precio,
                presentaciones: _this7.formProduct.value.presentaciones
              });

              _this7.dialogRef.close();

              console.log(_this7.downloadURL);
            })["catch"](function (err) {
              console.log(err);
            });
          })).subscribe();
        ...
        value: function validateAllFormFields(formGroup) {
          ...
          Object.keys(formGroup.controls).forEach(function (field) {
            ...
            if (control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]) {
              ...
              _this8.validateAllFormFields(control);
            }
          });
        }
      }, {
    ...
    EditarProductoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EditarProductoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditarProductoComponent_Template_button_click_4_listener() {
            return ctx.cancelar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function EditarProductoComponent_Template_form_submit_7_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, "Categor\xEDa");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function EditarProductoComponent_Template_ngx_mat_file_input_change_33_listener($event) {
            return ctx.detectFiles($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](39, "Peso m\xE1ximo de la imagen: 1 MB.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](48, " Confirmar edici\xF3n ");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditarProductoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _classes_producto__WEBPACK_IMPORTED_MODULE_11__["Producto"],
          decorators: [{
          ...
          type: src_app_services_firebase_service__WEBPACK_IMPORTED_MODULE_7__["FirebaseService"]
        }, {
  ...
  /***/
  function srcAppComponentsEliminarProductoEliminarProductoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EliminarProductoComponent", function () {
      return EliminarProductoComponent;
    });
    /* harmony import */
    ...
    var src_app_classes_producto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/classes/producto */
    "./src/app/classes/producto.ts");
    /* harmony import */
    ...
    function EliminarProductoComponent_mat_icon_27_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EliminarProductoComponent_mat_spinner_28_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EliminarProductoComponent = /*#__PURE__*/function () {
      function EliminarProductoComponent(fs, dialogRef, data, snackBar) {
        _classCallCheck(this, EliminarProductoComponent);
      ...
      _createClass(EliminarProductoComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "eliminarProducto",
        value: function eliminarProducto(idProduct, imageName) {
          var _this9 = this;

          this.deshabilitado = true;
          this.fs.deleteProduct(idProduct).then(function () {
            _this9.dialogRef.close();

            _this9.snackBar.open('Producto eliminado', 'CERRAR', {
              duration: 3000
            });
          });
    ...
    EliminarProductoComponent.ɵfac = function EliminarProductoComponent_Factory(t) {
      return new (t || EliminarProductoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_2__["FirebaseService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]));
    };

    EliminarProductoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EliminarProductoComponent,
      selectors: [["app-eliminar-producto"]],
      decls: 30,
      vars: 5,
      consts: [[1, "d-flex", "justify-content-between", "align-items-center", "mb-2", "mb-md-3"], [1, "tituloModal", "text-danger"], ["mat-icon-button", "", 3, "click"], [1, ""], [1, "lead"], [1, "alert", "alert-danger"], [1, "mb-0"], [1, "small", "text-danger", "mb-3", "mb-md-4"], [3, "inline"], [1, "text-right"], [1, "btn", "btn-link", 3, "click"], [1, "btn", "btn-danger", "ml-3", 3, "click"], ["class", "align-middle", 4, "ngIf"], ["class", "float-left mr-2", 3, "diameter", 4, "ngIf"], [1, "align-middle"], [1, "float-left", "mr-2", 3, "diameter"]],
      template: function EliminarProductoComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EliminarProductoComponent_Template_button_click_4_listener() {
            return ctx.cancelar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "\xBFEst\xE1 seguro que desea eliminar el siguiente producto?");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "C\xF3digo:");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](22, " Esta acci\xF3n no se puede deshacer.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EliminarProductoComponent_Template_button_click_24_listener() {
            return ctx.cancelar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EliminarProductoComponent_Template_button_click_26_listener() {
            return ctx.eliminarProducto(ctx.data.id, ctx.data.imageName);
          });
      ...
      directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_8__["MatSpinner"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EliminarProductoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_app_classes_producto__WEBPACK_IMPORTED_MODULE_4__["Producto"],
          decorators: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"],
            args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]]
          }]
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function FooterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Direcci\xF3n");
  ...
  function srcAppComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _menu_mobile_menu_mobile_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../menu-mobile/menu-mobile.component */
    "./src/app/components/menu-mobile/menu-mobile.component.ts");
    /* harmony import */
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      function HeaderComponent(ds, dialog) {
      ...
      _createClass(HeaderComponent, [{
        ...
        key: "openModalMenuMobile",
        value: function openModalMenuMobile() {
          var dialogRef = this.dialog.open(_menu_mobile_menu_mobile_component__WEBPACK_IMPORTED_MODULE_1__["MenuMobileComponent"], {
            panelClass: 'modalFullScreen'
          });
          dialogRef.afterClosed().subscribe();
        }
    ...
    HeaderComponent.ɵfac = function HeaderComponent_Factory(t) {
      return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"]));
    };
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](31, "Cat\xE1logo");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_button_click_41_listener() {
            return ctx.openModalMenuMobile();
          });
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButton"]],
  ...
  function srcAppComponentsInicioInicioComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../card-producto/card-producto.component */
    "./src/app/components/card-producto/card-producto.component.ts");

    function InicioComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InicioComponent_app_card_producto_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 41);
      }

      if (rf & 2) {
        var producto_r7 = ctx.$implicit;
    ...
    var InicioComponent = /*#__PURE__*/function () {
      function InicioComponent(fs, ds) {
    ...
    InicioComponent.ɵfac = function InicioComponent_Factory(t) {
      return new (t || InicioComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_1__["FirebaseService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]));
    };
    ...
    InicioComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function InicioComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](28, "Contamos con una gran variedad de productos veterinarios para animales de compa\xF1ia como gatos, perros, etc.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](36, "Somos una empresa peruana con varios a\xF1os de experiencia en la salud, desarrollo y el bienestar animal. Contamos con socios estrat\xE9gicos, lo cual nos permite especializarnos en l\xEDneas de productos veterinarios de primera l\xEDnea e importancia a nivel mundial para el bienestar animal.");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](37, "a", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](38, "Conoce m\xE1s de nosotros");
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgClass"], _card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_5__["CardProductoComponent"]],
  ...
  /***/
  function srcAppComponentsMenuMobileMenuMobileComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MenuMobileComponent", function () {
    ...
    function MenuMobileComponent_a_5_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 8);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MenuMobileComponent_a_5_Template_a_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);

          var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r2.cancelar();
        });
    ...
    var MenuMobileComponent = /*#__PURE__*/function () {
      function MenuMobileComponent(ds, dialogRef) {
        _classCallCheck(this, MenuMobileComponent);

        this.ds = ds;
        this.dialogRef = dialogRef;
      }

      _createClass(MenuMobileComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.links = this.ds.links;
        }
    ...
    MenuMobileComponent.ɵfac = function MenuMobileComponent_Factory(t) {
      return new (t || MenuMobileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"]));
    };

    MenuMobileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MenuMobileComponent,
      selectors: [["app-menu-mobile"]],
      decls: 14,
      vars: 1,
      consts: [[1, "text-right"], ["mat-icon-button", "", 3, "click"], [1, "d-flex", "flex-column", "text-center"], ["class", "lead my-2", 3, "routerLink", "click", 4, "ngFor", "ngForOf"], ["href", "https://imexvetperu.riqra.com/", "target", "_blank", 1, "btn", "btn-secondary", "ml-3"], [1, "small", "text-muted", "border-top", "mt-3", "pt-3"], ["href", "mailto:info@imexvetperu.com", 1, "text-reset"], ["href", "tel:013459413", 1, "text-reset"], [1, "lead", "my-2", 3, "routerLink", "click"]],
      template: function MenuMobileComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MenuMobileComponent_Template_button_click_1_listener() {
            return ctx.cancelar();
          });
      ...
      directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MenuMobileComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsNosotrosNosotrosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function NosotrosComponent_div_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    NosotrosComponent.ɵfac = function NosotrosComponent_Factory(t) {
      return new (t || NosotrosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_1__["FirebaseService"]));
    };
    ...
    NosotrosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 28,
      vars: 3,
      consts: [[1, "py-5", "py-md-7", "bgNosotros", "d-flex", "align-items-center"], [1, "col-md-6", "mx-auto", "text-center"], [1, "h1", "text-center", "text-white"], [1, "lead", "text-white"], [1, "col-md-10", "mx-auto"], [1, "bgMision", "py-5", "py-md-7", "my-4", "my-md-7", "rounded-lg"], [1, "col-md-6", "mx-auto", "text-center", "text-white"], [1, "h1"], [1, "lead"], [1, "bgVision", "py-5", "py-md-7", "my-4", "my-md-7", "rounded-lg"], [1, "col-md-7", "mx-auto", "text-center", "text-white"], [1, "py-4", "pb-md-6", "pt-md-0"], [1, "text-center", "col-md-6", "mx-auto", "my-3", "my-md-5"], [1, "h3", "text-primary"], [1, "grillaMarcas"], ["class", "boxMarca", 4, "ngFor", "ngForOf"], [1, "boxMarca"], [3, "src"]],
      template: function NosotrosComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Con varios a\xF1os de experiencia en la salud, desarrollo y el bienestar animal. Contamos con socios estrat\xE9gicos, lo cual nos permite especializarnos en l\xEDneas de productos veterinarios de primera l\xEDnea e importancia a nivel mundial para el bienestar animal. ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Misi\xF3n");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "p", 8);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "Comercializar productos innovadores y de alta calidad que contribuyan a la prevenci\xF3n, tratamiento y control de enfermedades en animales de producci\xF3n y de compa\xF1\xEDa.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, "Visi\xF3n");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](17, "p", 8);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, "Convertirnos en el mejor socio estrat\xE9gico para veterinarias, productores y due\xF1os de mascotas. Buscamos posicionarnos como una empresa proactiva, solida y diversificada permiti\xE9ndonos ser uno de los ejes principales en temas relacionados a la salud animal.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](24, "Contamos con una gran variedad de productos veterinarios para animales de compa\xF1ia como gatos, perros, etc.");
  ...
  /***/
  function srcAppComponentsProductoDetalleAdminProductoDetalleAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductoDetalleAdminComponent", function () {
      return ProductoDetalleAdminComponent;
    });
    /* harmony import */
    ...
    var src_app_classes_producto__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/classes/producto */
    "./src/app/classes/producto.ts");
    /* harmony import */
    ...
    function ProductoDetalleAdminComponent_span_22_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductoDetalleAdminComponent_span_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ProductoDetalleAdminComponent_span_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ProductoDetalleAdminComponent_div_38_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 11);
      ...
      if (rf & 2) {
        var presentacion_r6 = ctx.$implicit;
    ...
    function ProductoDetalleAdminComponent_div_38_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductoDetalleAdminComponent_div_39_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var ProductoDetalleAdminComponent = /*#__PURE__*/function () {
      function ProductoDetalleAdminComponent(dialogRef, data, fs) {
        _classCallCheck(this, ProductoDetalleAdminComponent);
      ...
      _createClass(ProductoDetalleAdminComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "cancelar",
    ...
    ProductoDetalleAdminComponent.ɵfac = function ProductoDetalleAdminComponent_Factory(t) {
      return new (t || ProductoDetalleAdminComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_firebase_service__WEBPACK_IMPORTED_MODULE_2__["FirebaseService"]));
    };

    ProductoDetalleAdminComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductoDetalleAdminComponent,
      selectors: [["app-producto-detalle-admin"]],
      decls: 40,
      vars: 11,
      consts: [[1, "container", "p-0", "py-md-5"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-2", "mb-md-3"], [1, "h4", "mb-0", "text-primary"], ["mat-icon-button", "", "color", "primary", 3, "click"], [1, "row"], [1, "col-md-4"], ["width", "100%", 1, "border", "rounded-lg", 3, "src"], [1, "small", "text-muted"], [4, "ngIf"], [1, "small", "text-muted", "mb-1"], ["class", "border-bottom d-flex justify-content-between py-2", 4, "ngFor", "ngForOf"], [1, "border-bottom", "d-flex", "justify-content-between", "py-2"]],
      template: function ProductoDetalleAdminComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductoDetalleAdminComponent_Template_button_click_4_listener() {
            return ctx.cancelar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, "C\xF3digo:");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](26, "Categor\xEDa:");
      ...
      directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductoDetalleAdminComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_app_classes_producto__WEBPACK_IMPORTED_MODULE_3__["Producto"],
          decorators: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"],
            args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]]
          }]
  ...
  /***/
  function srcAppComponentsProductosGatosProductosGatosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductosGatosComponent", function () {
      return ProductosGatosComponent;
    });
    /* harmony import */
    ...
    var _card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../card-producto/card-producto.component */
    "./src/app/components/card-producto/card-producto.component.ts");

    function ProductosGatosComponent_div_2_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductosGatosComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosGatosComponent_div_3_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }
    ...
    function ProductosGatosComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Alimento H\xFAmedo");
    ...
    function ProductosGatosComponent_div_4_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }
    ...
    function ProductosGatosComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Nutrac\xE9uticos");
    ...
    function ProductosGatosComponent_div_5_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }
    ...
    function ProductosGatosComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosGatosComponent_div_6_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r15 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r15);
      }
    }

    function ProductosGatosComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosGatosComponent_div_7_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r17 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r17);
      }
    }

    function ProductosGatosComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var ProductosGatosComponent = /*#__PURE__*/function () {
      function ProductosGatosComponent(fs) {
        _classCallCheck(this, ProductosGatosComponent);

        this.fs = fs;
      }

      _createClass(ProductosGatosComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this10 = this;

          this.fs.getProductosGatosAlimentoSeco().subscribe(function (res) {
            _this10.productosGatosAlimentoSeco = res;
          });
          this.fs.getProductosGatosAlimentoHumedo().subscribe(function (res) {
            _this10.productosGatosAlimentoHumedo = res;
          });
          this.fs.getProductosGatosNutraceuticos().subscribe(function (res) {
            _this10.productosGatosNutraceuticos = res;
          });
          this.fs.getProductosGatosAntipulgas().subscribe(function (res) {
            _this10.productosGatosAntipulgas = res;
          });
          this.fs.getProductosGatosVacunas().subscribe(function (res) {
            _this10.productosGatosVacunas = res;
          });
          this.fs.getProductosGatosHigieneCuidado().subscribe(function (res) {
            _this10.productosGatosHigieneCuidado = res;
          });
        }
      }]);
    ...
    ProductosGatosComponent.ɵfac = function ProductosGatosComponent_Factory(t) {
      return new (t || ProductosGatosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_firebase_service__WEBPACK_IMPORTED_MODULE_1__["FirebaseService"]));
    };

    ProductosGatosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductosGatosComponent,
      selectors: [["app-productos-gatos"]],
      decls: 8,
      vars: 6,
      consts: [[1, "bg-light"], [1, "col-md-10", "mx-auto", "py-4", "pb-md-6"], [4, "ngIf"], [1, "tituloGrupo"], [1, "grillaProducts"], [3, "producto", 4, "ngFor", "ngForOf"], [3, "producto"]],
      template: function ProductosGatosComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _card_producto_card_producto_component__WEBPACK_IMPORTED_MODULE_3__["CardProductoComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductosGatosComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsProductosPerrosProductosPerrosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductosPerrosComponent", function () {
      return ProductosPerrosComponent;
    });
    /* harmony import */
    ...
    function ProductosPerrosComponent_div_2_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }
    ...
    function ProductosPerrosComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosPerrosComponent_div_3_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r8 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r8);
      }
    }

    function ProductosPerrosComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosPerrosComponent_div_4_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r10 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r10);
      }
    }

    function ProductosPerrosComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosPerrosComponent_div_5_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r12 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r12);
      }
    }

    function ProductosPerrosComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ProductosPerrosComponent_div_6_app_card_producto_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-card-producto", 6);
      }

      if (rf & 2) {
        var producto_r14 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("producto", producto_r14);
      }
    }

    function ProductosPerrosComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var ProductosPerrosComponent = /*#__PURE__*/function () {
      function ProductosPerrosComponent(fs) {
        _classCallCheck(this, ProductosPerrosComponent);

        this.fs = fs;
      }

      _createClass(ProductosPerrosComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this11 = this;

          this.fs.getProductosPerrosAlimentoSeco().subscribe(function (res) {
            _this11.productosPerrosAlimentoSeco = res;
          });
          this.fs.getProductosPerrosAlimentoHumedo().subscribe(function (res) {
            _this11.productosPerrosAlimentoHumedo = res;
          });
          this.fs.getProductosPerrosNutraceuticos().subscribe(function (res) {
            _this11.productosPerrosNutraceuticos = res;
          });
          this.fs.getProductosPerrosAntipulgas().subscribe(function (res) {
            _this11.productosPerrosAntipulgas = res;
          });
          this.fs.getProductosPerrosVacunas().subscribe(function (res) {
            _this11.productosPerrosVacunas = res;
          });
        }
      }]);
    ...
    ProductosPerrosComponent.ɵfac = function ProductosPerrosComponent_Factory(t) {
      return new (t || ProductosPerrosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_firebase_service__WEBPACK_IMPORTED_MODULE_1__["FirebaseService"]));
    };

    ProductosPerrosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductosPerrosComponent,
      selectors: [["app-productos-perros"]],
      decls: 7,
      vars: 5,
      consts: [[1, "bg-light"], [1, "col-md-10", "mx-auto", "py-4", "pb-md-6"], [4, "ngIf"], [1, "tituloGrupo"], [1, "grillaProducts"], [3, "producto", 4, "ngFor", "ngForOf"], [3, "producto"]],
      template: function ProductosPerrosComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductosPerrosComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsPublicPublicComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _menu_mobile_menu_mobile_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../menu-mobile/menu-mobile.component */
    "./src/app/components/menu-mobile/menu-mobile.component.ts");
    /* harmony import */
    ...
    PublicComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 1,
      consts: [["mode", "over", "position", "end"], ["drawer", ""], [3, "drawer"]],
  ...
  /***/
  function srcAppComponentsPuntosVentaPuntosVentaComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PuntosVentaComponent", function () {
      return PuntosVentaComponent;
    });
    /* harmony import */
    ...
    function PuntosVentaComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var puntoVenta_r2 = ctx.$implicit;
    ...
    function PuntosVentaComponent_tr_19_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var puntoVenta_r3 = ctx.$implicit;
    ...
    var PuntosVentaComponent = /*#__PURE__*/function () {
      function PuntosVentaComponent(ds) {
        _classCallCheck(this, PuntosVentaComponent);

        this.ds = ds;
      }

      _createClass(PuntosVentaComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
    ...
    PuntosVentaComponent.ɵfac = function PuntosVentaComponent_Factory(t) {
      return new (t || PuntosVentaComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"]));
    };

    PuntosVentaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PuntosVentaComponent,
      selectors: [["app-puntos-venta"]],
      decls: 20,
      vars: 2,
      consts: [[1, "col-md-10", "mx-auto", "py-4", "py-md-6"], [1, "h1", "text-center", "text-primary"], [1, "bgPuntosVenta", "mb-4", "mb-md-6", "rounded-lg"], [1, "d-block", "d-md-none"], [1, "grillaPuntosVenta"], ["class", "border rounded-lg px-3 py-2 d-flex flex-column flex-md-row justify-content-between", 4, "ngFor", "ngForOf"], [1, "d-none", "d-md-block"], [1, "table-responsive"], [1, "table"], [1, "text-primary"], ["scope", "col"], [4, "ngFor", "ngForOf"], [1, "border", "rounded-lg", "px-3", "py-2", "d-flex", "flex-column", "flex-md-row", "justify-content-between"], [1, "small", "text-muted"], [1, "mb-0"], ["target", "blank", 3, "href"], ["target", "blank", 2, "word-break", "break-all", 3, "href"]],
      template: function PuntosVentaComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PuntosVentaComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataService = function DataService() {
      ...
      this.tipos = ['Presentación única', 'Presentación múltiple'];
      this.medidas = ['Gr.', 'Kg.', 'Ml.', 'Tab.']; // puntosVenta = [
      //   {
  ...
  function srcAppServicesFirebaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FirebaseService = /*#__PURE__*/function () {
      ...
      _createClass(FirebaseService, [{
        key: "addProduct",
        value: function addProduct(dataProduct) {
        ...
        key: "deleteProductStorage",
        value: function deleteProductStorage(idProduct, imageName) {
          return this.storage.ref("imagesProducts/".concat(idProduct, "/").concat(imageName))["delete"]();
        }
      }, {
        key: "updateProduct",
        value: function updateProduct(idProduct, dataProduct) {
          return this.afs.collection('productos').doc(idProduct).update(dataProduct);
        }
      }, {
        key: "updateAprobado",
        value: function updateAprobado(idProducto, publicado) {
          this.afs.doc('productos/' + idProducto).update({
            publicado: publicado
          });
        }
      }, {
        key: "updateDestacado",
        value: function updateDestacado(idProducto, destacado) {
          this.afs.doc('productos/' + idProducto).update({
            destacado: destacado
          });
        }
        ...
        value: function getAllProducts() {
          return this.afs.collection('productos', function (ref) {
            return ref.orderBy('fechaCreacion', 'desc');
        ...
        value: function getProducts() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('publicado', '==', true);
          } // .orderBy('nombre', 'asc')
          ).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
              var data = a.payload.doc.data();
        ...
        key: "getProductsHome",
        value: function getProductsHome() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('publicado', '==', true).where('destacado', '==', true);
          } // .limit(4)
          // .orderBy('nombre', 'asc')
          ).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
        ...
        value: function getMarcas() {
          return this.afs.collection('marcas', function (ref) {
            return ref // .where('publicado', '==', true)
            .orderBy('orden', 'asc');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
        ...
        value: function getCategorias() {
          return this.afs.collection('categorias', function (ref) {
            return ref;
        ...
        key: "getAnimales",
        value: function getAnimales() {
          return this.afs.collection('animales', function (ref) {
            return ref // .where('publicado', '==', true)
            .orderBy('nombre', 'desc');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
        ...
        key: "getProductosPerros",
        value: function getProductosPerros() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).orderBy('marca', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosPerrosAlimentoSeco",
        value: function getProductosPerrosAlimentoSeco() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).where('categoria', '==', 'Alimento Seco').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosPerrosAlimentoHumedo",
        value: function getProductosPerrosAlimentoHumedo() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).where('categoria', '==', 'Alimento Húmedo').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosPerrosNutraceuticos",
        value: function getProductosPerrosNutraceuticos() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).where('categoria', '==', 'Nutracéuticos').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosPerrosAntipulgas",
        value: function getProductosPerrosAntipulgas() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).where('categoria', '==', 'Antipulgas').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosPerrosVacunas",
        value: function getProductosPerrosVacunas() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.perro', '==', true).where('categoria', '==', 'Vacunas').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        } // Gatos

      }, {
        key: "getProductosGatos",
        value: function getProductosGatos() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).orderBy('marca', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosAlimentoSeco",
        value: function getProductosGatosAlimentoSeco() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Alimento Seco').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosAlimentoHumedo",
        value: function getProductosGatosAlimentoHumedo() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Alimento Húmedo').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosNutraceuticos",
        value: function getProductosGatosNutraceuticos() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Nutracéuticos').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosAntipulgas",
        value: function getProductosGatosAntipulgas() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Antipulgas').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosHigieneCuidado",
        value: function getProductosGatosHigieneCuidado() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Higiene y cuidado').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }, {
        key: "getProductosGatosVacunas",
        value: function getProductosGatosVacunas() {
          return this.afs.collection('productos', function (ref) {
            return ref.where('familia.gato', '==', true).where('categoria', '==', 'Vacunas').where('publicado', '==', true).orderBy('marca', 'asc').orderBy('fechaCreacion', 'asc');
          }).valueChanges();
        }
      }]);
    ...
    FirebaseService.ɵfac = function FirebaseService_Factory(t) {
      return new (t || FirebaseService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_storage__WEBPACK_IMPORTED_MODULE_3__["AngularFireStorage"]));
    };
